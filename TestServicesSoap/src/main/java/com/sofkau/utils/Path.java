...
public enum Path {
    ...
    SOAP_TEMPERATURA_BASE_URL("http://www.w3schools.com/"),
    RESOURCE_TEMPERATURA("xml/tempconvert.asmx"),
    BODY_TEMPERATURA_PATH("src/test/resources/soap/fileTemperaturaConversion.xml");
